...
p_rep = '''<div class="svc-problem-body">
            ...
            <p>It should travel further to become:</p>
            <ul class="svc-problem-gaps">
              <li><span class="gap-mark"><svg viewBox="0 0 24 24"><path d="M12 2L22 22H2L12 2Z"/></svg></span><span class="gap-text">A campaign film or product story.</span></li>
              <li><span class="gap-mark"><svg viewBox="0 0 24 24"><path d="M12 2L22 22H2L12 2Z"/></svg></span><span class="gap-text">A teaser or vertical cut for social.</span></li>
              <li><span class="gap-mark"><svg viewBox="0 0 24 24"><path d="M12 2L22 22H2L12 2Z"/></svg></span><span class="gap-text">A training asset or multilingual version.</span></li>
            </ul>
...
vs_pipe_rep = '''<div class="svc-vs-pipeline">
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Core Creative Idea</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Campaign Film</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Product Teaser</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Vertical Cut</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Sales Explainer</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Multilingual Edit</span>
            </div>
            <div class="svc-vs-step">
              <span class="step-dot"></span>
              <span class="step-label">Final Deployment</span>
            </div>
          </div>
          <p class="svc-vs-closing">'''
html = replace_block(html, vs_pipe_start, vs_pipe_end, vs_pipe_rep)
html = html.replace('AI should not replace the people who understand your business. It should remove the repetitive work that stops them from doing their best work.', 'AI can generate visuals, avatars, and edits. But taste, context, and brand tone matter. The goal is not AI-looking content. The goal is better video, made faster.')
...
c_rep = '''<div class="svc-channels-orbit">
            ...
            <!-- Hidden chips for the 12 total, reusing existing 8 orbit spots by rotating text or just displaying 8 top ones, but we have 12 so we will randomly distribute the remaining 4 near the inner ring if possible, but for simplicity we will just put them in the orbit list -->
            ...
            <span class="svc-channel-chip" style="left: 35%; top: 65%;">Internal comms</span>
...
# 8. Connected Systems
html = html.replace('Connected to the Systems<br>That Run Your Business', 'Integrated With Your<br>Production Needs')
html = html.replace('Agents don’t work in isolation. They integrate directly into the tools your team already uses to manage data and workflows.', 'AI video doesn\'t exist in a vacuum. It integrates into your marketing stack and production workflows.')
html = html.replace('Two-way data sync across platforms.', 'Fast turnaround times for campaigns.')
html = html.replace('Secure, authenticated API connections.', 'Consistent brand identity across assets.')
html = html.replace('Real-time status updates and logging.', 'Scalable output for multiple regions.')
html = html.replace('<div class="svc-system-pill">Salesforce</div>', '<div class="svc-system-pill">Campaigns</div>')
html = html.replace('<div class="svc-system-pill">HubSpot</div>', '<div class="svc-system-pill">Social</div>')
html = html.replace('<div class="svc-system-pill">Zendesk</div>', '<div class="svc-system-pill">Internal</div>')
html = html.replace('<div class="svc-system-pill">Custom APIs</div>', '<div class="svc-system-pill">Ads</div>')
...
html = html.replace('We build AI agents with strict guardrails so they never hallucinate answers, make unapproved offers, or access restricted data.', 'Without it, the output can look random, inconsistent, or forgettable.')

g_start = '<div class="svc-guard-list">'
g_end = '</div>\n        <h3 class="svc-guard-punchline">'
g_rep = '''<div class="svc-guard-list">
          <div class="svc-guard-row">
            ...
            <div class="svc-guard-desc">Defining the core objective before any generation.</div>
          </div>
          <div class="svc-guard-row">
            <span class="mark-glyph"><svg viewBox="801 344 274 272"><use href="#impulse-mark" /></svg></span>
            <div class="svc-guard-title">Script and structure</div>
            <div class="svc-guard-desc">Writing the flow, voiceover, and key moments.</div>
          </div>
          <div class="svc-guard-row">
            <span class="mark-glyph"><svg viewBox="801 344 274 272"><use href="#impulse-mark" /></svg></span>
            <div class="svc-guard-title">Visual treatment</div>
            <div class="svc-guard-desc">Setting the style, mood, and references.</div>
          </div>
          <div class="svc-guard-row">
            <span class="mark-glyph"><svg viewBox="801 344 274 272"><use href="#impulse-mark" /></svg></span>
            <div class="svc-guard-title">AI-generated scenes and edits</div>
            <div class="svc-guard-desc">Creating visuals, motion, and variations.</div>
          </div>
          <div class="svc-guard-row">
            <span class="mark-glyph"><svg viewBox="801 344 274 272"><use href="#impulse-mark" /></svg></span>
            <div class="svc-guard-title">Human editing and final polish</div>
            <div class="svc-guard-desc">Refining pacing, sound, and brand consistency.</div>
          </div>
        </div>
        <h3 class="svc-guard-punchline">'''
html = replace_block(html, g_start, g_end, g_rep)
html = html.replace('Speed matters.', 'The tool creates the asset.')
html = html.replace('Control matters more.', 'The thinking decides.')
