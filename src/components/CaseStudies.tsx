    ...
    <section className="cosmos-section" id="cases-pin">
      ...
      <div className="cosmos-wrapper">
        <Link to="/case-studies/abg-brut-india/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/ABG x Brut India/ABG Brut India Title.png`} className="hs-card-img" alt="Aditya Birla Group x Brut India Digital Marketing Campaign Case Study" loading="lazy" decoding="async"  width="600" height="400" />
        ...
        <Link to="/case-studies/abg-kbc/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/ABG x KBC/ABG x KBC Title.png`} className="hs-card-img" alt="Aditya Birla Group x KBC CSR Campaign Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/automag-india/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Automag India/Automag SEO/Automag Title.jpg`} className="hs-card-img" alt="Automag India B2B SEO and Lead Generation Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/automag-bajaj-auto/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Automag India/Automag x Bajaj Auto title.png`} className="hs-card-img" alt="Automag x Bajaj Auto B2B Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/dmart/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Dmart/Dmart Title.png`} className="hs-card-img" alt="DMart Retail Footfall Generation Campaign Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/electromech/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/ElectroMech/ElectroMech title.png`} className="hs-card-img" alt="ElectroMech B2B Website Development and SEO Growth" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/fours-for-good/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Fours for good/Fours for good title.png`} className="hs-card-img" alt="Aditya Birla Group Fours for Good CSR Campaign" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/hul/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/HUL 1/HUL 1 Title.png`} className="hs-card-img" alt="Hindustan Unilever Performance Marketing and Coupon Campaign" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/lg-hing/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/LG/LG title.png`} className="hs-card-img" alt="LG Hing Diwali Social Media Campaign" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/mastercard/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Mastercard/Mastercard Title.png`} className="hs-card-img" alt="Mastercard WhatsApp Marketing and Merchant Outreach Strategy" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/qure-ai/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Qure.ai/QureAI Title.png`} className="hs-card-img" alt="Qure.ai Healthcare AI SEO Traffic Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
        ...
        <Link to="/case-studies/uppercase/" className="cosmos-card" style={{ textDecoration: 'none', color: 'inherit' }}>
          <img src={`${import.meta.env.BASE_URL}case studies/Written Content/Uppercase/Uppercase Title.png`} className="hs-card-img" alt="Uppercase AI-Led Social Media Campaign Case Study" loading="lazy" decoding="async"  width="600" height="400" />
          <div className="hs-card-inner">
