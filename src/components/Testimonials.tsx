          ...
          <div className="test-card-col">
            <div className="test-card">
              <div className="test-content">
                ...
                <div className="author-block">
                  <img src={`${import.meta.env.BASE_URL}images/Sachin.png`} alt="Sachin Mane" className="author-img" />
                  <div className="author-info">
          ...
          <div className="test-card-col">
            <div className="test-card">
              <div className="test-content">
                ...
                <div className="author-block">
                  <img src={`${import.meta.env.BASE_URL}images/Richa.png`} alt="Richa Dholi" className="author-img" />
                  <div className="author-info">
