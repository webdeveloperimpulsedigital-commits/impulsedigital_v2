...
const SeoNaviMumbaiLocation: React.FC = () => {
  ...
  return (
    <main id="main-content">
      <Helmet>
        <title>{hero.title + " | Impulse Digital"}</title>
        <meta name="description" content={hero.description.join(" ")} />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://www.theimpulsedigital.com/brand-infrastructure/search-engine-optimisation/${"navi-mumbai"}/`} />
      </Helmet>
