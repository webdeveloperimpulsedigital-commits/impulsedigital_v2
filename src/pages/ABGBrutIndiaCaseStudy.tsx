...
<meta name="twitter:site" content="@impulsedigi" />
      ...
      <div className="cs-feature-wrapper">
        <div className="cs-feature-image">
          <img src={`${base}case studies/Written Content/ABG x Brut India/ABG Brut India Title.webp`} alt="ABG x Brut India Force for Good campaign - Impulse Digital Marketing Case Study" />
        </div>
      </div>
      ...
      <section className="cs-proof-module">
        <div className="cs-proof-media gsap-fade-up">
          <img src={`${base}case studies/Written Content/ABG x Brut India/Supporting 1.webp`} alt="ABG x Brut India storytelling visual - Impulse Digital Marketing Case Study" />
        </div>
      ...
      <section className="cs-proof-module reverse">
        ...
        <div className="cs-proof-media gsap-fade-up">
          <img src={`${base}case studies/Written Content/ABG x Brut India/Supporting 2.webp`} alt="ABG x Brut India amplification visual - Impulse Digital Marketing Case Study" />
        </div>
      </section>
