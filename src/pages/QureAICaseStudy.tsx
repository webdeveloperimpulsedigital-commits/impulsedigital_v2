    ...
    <main id="main-content">
      ...
      <section className="cs-proof-module">
        <div className="cs-proof-media gsap-fade-up">
          <img src={`${base}case studies/Written Content/Qure.ai/Supporting 1.png`} alt="Qure.ai diagnostic scan interface with AI overlay" />
        </div>
      ...
      <section className="cs-proof-module reverse">
        ...
        <div className="cs-proof-media gsap-fade-up">
          <img src={`${base}case studies/Written Content/Qure.ai/Supporting 2.png`} alt="Qure.ai Google Analytics traffic and engagement performance" />
        </div>
      </section>
