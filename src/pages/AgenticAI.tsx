    ...
    <main id="main-content">
      ...
      <section className="svc-stats" id="warp-start">
        <div className="container">
          <h2 className="svc-h2 split-text">{agenticAiData.stats.title}</h2>
          <div className="svc-stats-grid">
            {agenticAiData.stats.metrics.map((stat, i) => (
          ...
          <p className="svc-stats-footnote">{agenticAiData.stats.footnote}</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="svc-channels-stage" id="channels-stage">
            ...
            <div className="svc-channels-orbit">
              <span className="svc-channel-chip" style={{ left: '18%', top: '20%' }}>WhatsApp</span>
              <span className="svc-channel-chip" style={{ left: '50%', top: '8%' }}>Email</span>
              <span className="svc-channel-chip" style={{ left: '82%', top: '20%' }}>Voice notes</span>
              <span className="svc-channel-chip" style={{ left: '92%', top: '50%' }}>Facebook Messenger</span>
              <span className="svc-channel-chip" style={{ left: '82%', top: '80%' }}>Instagram DM</span>
              <span className="svc-channel-chip" style={{ left: '50%', top: '92%' }}>SMS</span>
              <span className="svc-channel-chip" style={{ left: '18%', top: '80%' }}>Website chat</span>
              <span className="svc-channel-chip" style={{ left: '8%', top: '50%' }}>CRM workflows</span>
            </div>
          </div>
        </div>
      </section>
